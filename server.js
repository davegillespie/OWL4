...
app.post("/shipments-router", (req, res) => {
    ...
    console.log("data", data);
        ...
        pool.format("INSERT INTO shipments (id, pickup_facility_name, pickup_address, pickup_city, pickup_state, pickup_zip, pickup_phone, pickup_email, pickup_date, delivery_date, quantity, unit, weight, trailer,temperature, size, delivery_facitlity_name, delivery_address,delivery_city,delivery_state,delivery_zip,delivery_phone,delivery_email) VALUES %L ", data.id
        )
        .then( (result) => {
            res.send(result.rows);
        })

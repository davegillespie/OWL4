...
router.post("/orders-router", (req, res) => {
    let data = req.body[0];
    let id = data.id;
    console.log(data);
...
router.put("/orders-router/:id", (req, res) => {
...
router.get("/orders-router", (req, res) => {
 ...
 router.delete('/orders-router/:id', (req, res) => {
...
router.post("/shipments-router", (req, res) => {
    let data = req.body[0];
    let id = data.id;
    console.log(data);
...
router.get("/shipments-router", (req, res) => {
    pool.query("SELECT * FROM orders FULL JOIN shipments ON orders.id = shipments.shipment_id")
    .then( (result) => {
        res.send(result.rows);
    })
  });
 ...
 router.delete('/shipments-router/:id', (req, res) => {
...
router.post("/carriers-router", (req, res) => {
...
// router.put("/carriers-router/:id", (req, res) => {
//     let id = req.params.id;
...
router.get("/carriers-router", (req, res) => {
 ...
 router.delete('/carriers-router/:carrier_id', (req, res) => {
...
router.post("/locations-router", (req, res) => {
...
// router.put("/locations-router/:loc_id", (req, res) => {
...
router.get("/locations-router", (req, res) => {
 ...
 router.delete('/locations-router/:loc_id', (req, res) => {
